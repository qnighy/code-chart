...
import type { GeneralCategoryCore, NameDerivation } from "./character-data";
    ...
    for (
      ...
      try {
        ...
        chunk.data.characters.push({
          codePoint,
          name:
            nameDerivation === "NAME_DERIVATION_UNSPECIFIED" ? row.name : "",
          nameDerivation,
...
const IdeographBaseNameMap: Record<string, NameDerivation> = {
  ...
  "CJK COMPATIBILITY IDEOGRAPH": "NAME_DERIVATION_CJK_UNIFIED_IDEOGRAPH",
